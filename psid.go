...
func (psid *PSIDHeader) PrintPSIDVitals() {
...
func (psid *PSIDHeader) LoadPSIDHeader(file *os.File) error {
...
func (psid *PSIDHeader) LoadPSIDData(cpu *cpu.CPU, file *os.File) error {
